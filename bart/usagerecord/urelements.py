...
ALLOC_RESOURCE      = QName("{%s}AllocResource"  % OGF_UR_NAMESPACE)
RESOURCE_TYPE       = QName("{%s}resourceType"   % OGF_UR_NAMESPACE)
RESOURCE_AMOUNT     = QName("{%s}resourceAmount" % OGF_UR_NAMESPACE)
